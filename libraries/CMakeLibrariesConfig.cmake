...
# make `klangstrom_KLST_EMU` headers available to `klangstrom`
...
# make `klangstrom` headers available to `klangstrom-emulator`
get_target_property(KLANGSTROM_INCLUDE_DIRS klangstrom INTERFACE_INCLUDE_DIRECTORIES)
target_include_directories(klangstrom-emulator PUBLIC ${KLANGSTROM_INCLUDE_DIRS})
